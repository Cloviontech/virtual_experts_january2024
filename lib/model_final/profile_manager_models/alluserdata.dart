...
//
//     final alluserdata = alluserdataFromJson(jsonString);

import 'dart:convert';

List<Alluserdata> alluserdataFromJson(String str) => List<Alluserdata>.from(json.decode(str).map((x) => Alluserdata.fromJson(x)));

String alluserdataToJson(List<Alluserdata> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
