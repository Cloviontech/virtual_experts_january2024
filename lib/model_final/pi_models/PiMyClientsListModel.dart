...
//
//     final piMyClientsListModel = piMyClientsListModelFromJson(jsonString);

import 'dart:convert';

List<PiMyClientsListModel> piMyClientsListModelFromJson(String str) => List<PiMyClientsListModel>.from(json.decode(str).map((x) => PiMyClientsListModel.fromJson(x)));

String piMyClientsListModelToJson(List<PiMyClientsListModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class PiMyClientsListModel {
    int? id;
    String? uid;
    String? email;
    String? mobile;
    ...
    factory PiMyClientsListModel.fromJson(Map<String, dynamic> json) => PiMyClientsListModel(
        id: json["id"],
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
