...
//
//     final pfUidAllData = pfUidAllDataFromJson(jsonString);

import 'dart:convert';

PfUidAllData pfUidAllDataFromJson(String str) => PfUidAllData.fromJson(json.decode(str));

String pfUidAllDataToJson(PfUidAllData data) => json.encode(data.toJson());
...
class PfUidAllData {
    ...
    factory PfUidAllData.fromJson(Map<String, dynamic> json) => PfUidAllData(
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
