...
//
//     final salesAllDataModel = salesAllDataModelFromJson(jsonString);

import 'dart:convert';

List<SalesAllDataModel> salesAllDataModelFromJson(String str) => List<SalesAllDataModel>.from(json.decode(str).map((x) => SalesAllDataModel.fromJson(x)));

String salesAllDataModelToJson(List<SalesAllDataModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SalesAllDataModel {
    String? uid;
    String? email;
    String? mobile;
    String? password;
    ...
    factory SalesAllDataModel.fromJson(Map<String, dynamic> json) => SalesAllDataModel(
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
