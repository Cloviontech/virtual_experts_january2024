...
//
//     final viewAddisId = viewAddisIdFromJson(jsonString);

import 'dart:convert';

ViewAddisId viewAddisIdFromJson(String str) => ViewAddisId.fromJson(json.decode(str));

String viewAddisIdToJson(ViewAddisId data) => json.encode(data.toJson());
...
class ViewAddisId {
    ...
    factory ViewAddisId.fromJson(Map<String, dynamic> json) => ViewAddisId(
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
