...
//
//     final viewAdproId = viewAdproIdFromJson(jsonString);

import 'dart:convert';

ViewAdproId viewAdproIdFromJson(String str) => ViewAdproId.fromJson(json.decode(str));

String viewAdproIdToJson(ViewAdproId data) => json.encode(data.toJson());
...
class ViewAdproId {
    ...
    factory ViewAdproId.fromJson(Map<String, dynamic> json) => ViewAdproId(
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
