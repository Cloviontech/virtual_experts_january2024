...
//
//     final adDisListModel = adDisListModelFromJson(jsonString);

import 'dart:convert';

List<AdDisListModel> adDisListModelFromJson(String str) => List<AdDisListModel>.from(json.decode(str).map((x) => AdDisListModel.fromJson(x)));

String adDisListModelToJson(List<AdDisListModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class AdDisListModel {
    String? uid;
    String? email;
    String? mobile;
    String? password;
    ...
    factory AdDisListModel.fromJson(Map<String, dynamic> json) => AdDisListModel(
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
