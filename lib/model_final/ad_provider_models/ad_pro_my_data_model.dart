...
//
//     final adProMyDataModel = adProMyDataModelFromJson(jsonString);

import 'dart:convert';

List<AdProMyDataModel> adProMyDataModelFromJson(String str) => List<AdProMyDataModel>.from(json.decode(str).map((x) => AdProMyDataModel.fromJson(x)));

String adProMyDataModelToJson(List<AdProMyDataModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class AdProMyDataModel {
    String? uid;
    String? email;
    String? mobile;
    String? password;
    ...
    factory AdProMyDataModel.fromJson(Map<String, dynamic> json) => AdProMyDataModel(
        uid: json["uid"],
        email: json["email"],
        mobile: json["mobile"],
