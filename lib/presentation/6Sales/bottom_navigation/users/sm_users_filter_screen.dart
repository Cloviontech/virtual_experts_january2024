...
class SmUsersFilterScreen extends StatefulWidget {
  SmUsersFilterScreen({super.key});

  @override
  State<SmUsersFilterScreen> createState() => _SmUsersFilterScreenState();
}

class _SmUsersFilterScreenState extends State<SmUsersFilterScreen> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
