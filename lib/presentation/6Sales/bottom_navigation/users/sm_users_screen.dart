...
class SmAllUsersScreen extends StatefulWidget {
  SmAllUsersScreen({super.key});

  @override
  State<SmAllUsersScreen> createState() =>
      _SmAllUsersScreenState();
}

class _SmAllUsersScreenState
    extends State<SmAllUsersScreen> {
  List<String> roles = [
    'Regional Manager',
    'Local Admins',
    'Adprovider',
 ...
 static List<PmAllSecondaryUsersDataModel> _pmAllSecondaryUsersDataModel = [];

  // AdProAllUsersDataModel _pmAllSecondaryUsersDataModel = AdProAllUsersDataModel(); 
  ...
  Future<void> _fetchAllProfFindsData() async {
    ...
    final response =
        await http.get(Uri.parse("http://${ApiService.ipAddress}/pm_my_users_data/$ad_pro_user_id"));

    if (response.statusCode == 200) {
      List<dynamic> jsonResponse = jsonDecode(response.body);
      setState(() {
        _pmAllSecondaryUsersDataModel = jsonResponse
            .map((data) => PmAllSecondaryUsersDataModel.fromJson(data))
            .toList();
      ...
      debugPrint(_pmAllSecondaryUsersDataModel[0].firstName);
      debugPrint(_pmAllSecondaryUsersDataModel[0].accessPrivileges);
      debugPrint(_pmAllSecondaryUsersDataModel[1].firstName);
      debugPrint(_pmAllSecondaryUsersDataModel[1].accessPrivileges);
              ...
              if (_isLoading)
                ...
                Container(
                  ...
                  child: ListView.builder(
                            ...
                            MaterialPageRoute(builder: (context) {
                              return Id123456AboutMeLocalAdminScreen(
                                profile_finder_user_id:
                                    _pmAllSecondaryUsersDataModel[index].uid.toString(),
                              );
                            }),
                          );
                        },
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        //     //     _pmAllSecondaryUsersDataModel[index]
                                        //     //         .profilePicture
                                        //     //         .toString()),
                                        //   ),
                                        // ),
                                        ...
                                        SizedBox(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                _pmAllSecondaryUsersDataModel[index].firstName
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Switch(
                                          // value: isSwitched,
                                          value: _pmAllSecondaryUsersDataModel[index]
                                                  .email ==
                    ...
                    itemCount: _pmAllSecondaryUsersDataModel.length,
                  ),
                ),
            ],
          ),
