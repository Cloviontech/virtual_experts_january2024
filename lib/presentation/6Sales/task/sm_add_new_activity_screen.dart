...
class SmAddNewActScreen extends StatefulWidget {
  SmAddNewActScreen({super.key});

  @override
  State<SmAddNewActScreen> createState() => _SmAddNewActScreenState();
}

class _SmAddNewActScreenState extends State<SmAddNewActScreen> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
