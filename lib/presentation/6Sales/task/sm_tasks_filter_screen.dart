...
class SmTasksFilterScreen extends StatefulWidget {
  SmTasksFilterScreen({super.key});

  @override
  State<SmTasksFilterScreen> createState() => _SmTasksFilterScreenState();
}

class _SmTasksFilterScreenState extends State<SmTasksFilterScreen> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
