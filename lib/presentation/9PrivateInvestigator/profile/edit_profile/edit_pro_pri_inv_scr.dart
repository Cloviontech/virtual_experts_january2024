...
class EditProPriInvScr extends StatefulWidget {
  EditProPriInvScr({super.key});

  @override
  State<EditProPriInvScr> createState() =>
      _EditProPriInvScrState();
}

class _EditProPriInvScrState
    extends State<EditProPriInvScr> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
  ...
  pi_edit_account(
    {required String officeName,
      ...
      required String hiringManagerUid,
  ...
  final url = Uri.parse("http://${ApiService.ipAddress}/pi_edit_account/$private_investicator_id");
  ...
  request.files
        .add(await http.MultipartFile.fromPath('profile_picture', profPicFile !.path));
              ...
              child: MyElevatedButton(
                  onPressed: () {
                    pi_edit_account(
                      ...
                      hiringManagerUid: "hiringManagerUid",                           
