...
class AccountBalPriInvScr extends StatefulWidget {
  const AccountBalPriInvScr({super.key});

  @override
  State<AccountBalPriInvScr> createState() => _AccountBalPriInvScrState();
}

class _AccountBalPriInvScrState extends State<AccountBalPriInvScr> {
  List<String> roles = [
    'Regional Manager',
    'Local Admins',
    'Adprovider',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const ClAppbarLeadGridSuffHeart(
        testingNextPage: AccountBalPriInvScr(),
      ),
