...
class SettingsHiringManagerScreen extends StatefulWidget {
  SettingsHiringManagerScreen({super.key});

  @override
  State<SettingsHiringManagerScreen> createState() => _SettingsHiringManagerScreenState();
}

class _SettingsHiringManagerScreenState extends State<SettingsHiringManagerScreen> {
  List<String> roles = [
    'Regional Manager',
    'Local Admins',
    'Ad Distributor',
