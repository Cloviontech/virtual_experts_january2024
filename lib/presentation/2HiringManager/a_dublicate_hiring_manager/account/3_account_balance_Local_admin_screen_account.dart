...
class AccountBalanceLocalAdminScreenAccount extends StatefulWidget {
  AccountBalanceLocalAdminScreenAccount({super.key});

  @override
  State<AccountBalanceLocalAdminScreenAccount> createState() =>
      _AccountBalanceLocalAdminScreenAccountState();
}

class _AccountBalanceLocalAdminScreenAccountState
    extends State<AccountBalanceLocalAdminScreenAccount> {
  List<String> roles = [
    'Regional Manager',
    'Local Admins',
    'Adprovider',
          ...
          child: Column(
            ...
            children: [
             ...
             Text(
                ...
                D10HCustomClSizedBoxWidget(height: 50,),
              if (_isLoading)
                const Center(
                ...
                D10HCustomClSizedBoxWidget(height: 2,),
            ],
          ),
        ),
      ),
