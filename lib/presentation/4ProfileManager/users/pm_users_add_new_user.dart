...
class PmAddNewUserScreen extends StatefulWidget {
  PmAddNewUserScreen({super.key});

  @override
  State<PmAddNewUserScreen> createState() => _PmAddNewUserScreenState();
}

class _PmAddNewUserScreenState extends State<PmAddNewUserScreen> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
...
// "http://${ApiService.ipAddress}/ad_pro_my_data/$userId");
   ...
   String accessPrivilegesToString = access_Privileges.join(',');
    ...
    request.fields['work'] = 'profile_manager';
