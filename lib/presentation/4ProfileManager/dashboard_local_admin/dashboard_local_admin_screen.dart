...
class DashboardLocalAdminScreen extends StatefulWidget {
  @override
  State<DashboardLocalAdminScreen> createState() =>
      _DashboardLocalAdminScreenState();
}

class _DashboardLocalAdminScreenState extends State<DashboardLocalAdminScreen> {
...
Future<void> _fetchAllPrManagsData() async {
    ...
    final response =
        await http.get(Uri.parse("http://${ApiServices.ipAddress}/all_pm_data"));
