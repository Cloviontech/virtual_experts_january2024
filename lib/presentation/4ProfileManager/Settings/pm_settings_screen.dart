...
class PmSettingsScreen extends StatefulWidget {
  PmSettingsScreen({super.key});

  @override
  State<PmSettingsScreen> createState() => _PmSettingsScreenState();
}

class _PmSettingsScreenState extends State<PmSettingsScreen> {
  //
  ...
  Future<void> resetPassword(BuildContext context) async {
    ...
    var requestBody = {'pass_reset': emaiId};

    final responsepass = await http.post(
      Uri.parse('http://${ApiServices.ipAddress}/pm_password_reset/${_pmMyData[0].uid}'),
      body: requestBody,
    );
  ...
  Future<void> updateEmail(BuildContext context) async {
    ...
    final response = await http.post(
      Uri.parse('http://${ApiServices.ipAddress}/pm_email_update/' +
