...
class SettingsAffiliateMarketingScreen extends StatefulWidget {
  SettingsAffiliateMarketingScreen({super.key});

  @override
  State<SettingsAffiliateMarketingScreen> createState() => _SettingsAffiliateMarketingScreenState();
}

class _SettingsAffiliateMarketingScreenState extends State<SettingsAffiliateMarketingScreen> {
  List<String> roles = [
    'Regional Manager',
    'Local Admins',
    'Ad Distributor',
