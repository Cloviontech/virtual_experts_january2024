...
class AffliateMarketingAccountBalScr extends StatefulWidget {
  const AffliateMarketingAccountBalScr({super.key});

  @override
  State<AffliateMarketingAccountBalScr> createState() => _AffliateMarketingAccountBalScrState();
}

class _AffliateMarketingAccountBalScrState extends State<AffliateMarketingAccountBalScr> {
  List<String> roles = [
    'Regional Manager',
    'Local Admins',
    'Adprovider',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const ClAppbarLeadGridSuffHeart(
        testingNextPage: AffliateMarketingAccountBalScr(),
      ),
