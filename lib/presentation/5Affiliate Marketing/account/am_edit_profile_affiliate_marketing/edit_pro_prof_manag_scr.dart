...
class EditAccountAffiliateMarketing extends StatefulWidget {
  EditAccountAffiliateMarketing({super.key});

  @override
  State<EditAccountAffiliateMarketing> createState() =>
      _EditAccountAffiliateMarketingState();
}

class _EditAccountAffiliateMarketingState extends State<EditAccountAffiliateMarketing> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
