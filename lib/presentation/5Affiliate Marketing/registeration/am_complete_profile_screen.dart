...
class AmQualificationScreen extends StatefulWidget {
  const AmQualificationScreen({super.key});

  @override
  State<AmQualificationScreen> createState() => _AmQualificationScreenState();
}

class _AmQualificationScreenState extends State<AmQualificationScreen> {
