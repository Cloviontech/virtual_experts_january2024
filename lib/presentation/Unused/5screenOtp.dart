...
class Iphone1313ProSixScreen extends StatefulWidget {
  final int timerr;
  final String emailid;
  final String? id;

  const Iphone1313ProSixScreen({required this.timerr, required this.emailid, this.id});

  @override
  State<Iphone1313ProSixScreen> createState() => _Iphone1313ProSixScreenState();
}

class _Iphone1313ProSixScreenState extends State<Iphone1313ProSixScreen> {
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        MyElevatedButtonDisableColor(
                            onPressed: () {
                              // otp('http://34.235.126.169:8000/otp/', widget.emailid.toString());
                              //  otp('http://54.211.84.169:8000/otp/0MSBWITE6GZ', widget.id.toString());
                        ...
                        const Padding(
                          padding: EdgeInsets.only(top: 10),
                          child: Text("Resendd one-Time OTP"),
                        ),
                      ]),
                ),
              ))
