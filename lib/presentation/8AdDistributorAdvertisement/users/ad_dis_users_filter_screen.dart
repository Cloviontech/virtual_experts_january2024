...
class AdDisUsersFilterScreen extends StatefulWidget {
  AdDisUsersFilterScreen({super.key});

  @override
  State<AdDisUsersFilterScreen> createState() => _AdDisUsersFilterScreenState();
}

class _AdDisUsersFilterScreenState extends State<AdDisUsersFilterScreen> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
