...
class AdDisAddNewUserScreen extends StatefulWidget {
  AdDisAddNewUserScreen({super.key});

  @override
  State<AdDisAddNewUserScreen> createState() => _AdDisAddNewUserScreenState();
}

class _AdDisAddNewUserScreenState extends State<AdDisAddNewUserScreen> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
 ...
 "http://${ApiService.ipAddress}/ad_dis_add_user/$userId");
