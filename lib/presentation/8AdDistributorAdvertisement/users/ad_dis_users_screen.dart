...
import 'package:virtual_experts/presentation/8AdDistributorAdvertisement/users/ad_dis_users_add_new_user.dart';
import 'package:virtual_experts/presentation/8AdDistributorAdvertisement/users/ad_dis_users_filter_screen.dart';
import 'package:virtual_experts/widgets/CustomWidgetsCl/CustomClAll.dart';
import 'package:virtual_experts/core/utils/color_constant.dart';
import 'package:virtual_experts/core/utils/size_utils.dart';
import 'package:virtual_experts/widgets/CustomWidgetsCl/CustomWidgets.dart';

class AdDisAllUsersScreen extends StatefulWidget {
  AdDisAllUsersScreen({super.key});

  @override
  State<AdDisAllUsersScreen> createState() =>
      _AdDisAllUsersScreenState();
}

class _AdDisAllUsersScreenState
    extends State<AdDisAllUsersScreen> {
  List<String> roles = [
    'Regional Manager',
    'Local Admins',
    'Adprovider',
 ...
 static List<AdProAllUsersDataModel> _adProAllUsersDataModel = [];
  ...
  Future<void> _fetchAllProfFindsData() async {
    late String ad_dis_user_id;
     SharedPreferences preferences = await SharedPreferences.getInstance();
      ad_dis_user_id = preferences.getString("uid2").toString();

    final response =
        await http.get(Uri.parse("http://${ApiService.ipAddress}/ad_dis_my_users_data/$ad_dis_user_id"));
