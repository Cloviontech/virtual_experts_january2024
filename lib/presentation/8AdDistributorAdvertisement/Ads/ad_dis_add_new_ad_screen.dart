...
class AdDisAddNewAdScreen extends StatefulWidget {
  const AdDisAddNewAdScreen({super.key});

  @override
  State<AdDisAddNewAdScreen> createState() =>
      _AdDisAddNewAdScreenState();
}

class _AdDisAddNewAdScreenState extends State<AdDisAddNewAdScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ClAppbarLeadArrowBackSuffHeart(
        testingNextPage: const AdDisAddNewAdScreen(),
      ),
