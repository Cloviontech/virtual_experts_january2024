...
class AdProAddNewUserScreen extends StatefulWidget {
  AdProAddNewUserScreen({super.key});

  @override
  State<AdProAddNewUserScreen> createState() => _AdProAddNewUserScreenState();
}

class _AdProAddNewUserScreenState extends State<AdProAddNewUserScreen> {
  List<String> adType = [
    "Ad1",
    "Ad2",
    "Ad3",
