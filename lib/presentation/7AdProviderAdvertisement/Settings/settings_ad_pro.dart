...
class settings_ad_provider extends StatefulWidget {
  settings_ad_provider({super.key});

  @override
  State<settings_ad_provider> createState() =>
      _settings_ad_providerState();
}

class _settings_ad_providerState extends State<settings_ad_provider> {
  var userId;
  var emaiId;
  ...
  Future<void> resetPassword(BuildContext context) async {
    ...
    final responsepass = await http.post(
      Uri.parse('http://${ApiServices.ipAddress}/ad_pro_password_reset/' +
  ...
  Future<void> updateEmail(BuildContext context) async {
    ...
    final response = await http.post(
      Uri.parse('http://${ApiServices.ipAddress}/ad_pro_email_update/' +
          preferences.getString("id").toString()),
